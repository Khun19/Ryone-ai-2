...
You MUST return your answer strictly as a valid JSON object with the following fields and nothing else (no markdown wrappers like ```json):
{
  ...
  "responseTextMy": "Polite Burmese response describing what you are doing or answering the user's conversational request"
    ...
    private fun getSimulatedResponse(
        ...
        val modelHeader = "🤖 Model: $model | Modality: $modality"
        val detailHeader = "📌 Local simulation fallback mode active."
        return when {
            trimmed.contains("email") || trimmed.contains("အီးမေးလ်") -> {
                "$modelHeader\n$detailHeader\n\nလေးစားအပ်ပါသော လူကြီးမင်းခင်ဗျာ၊\n\nယခုအီးမေးလ်သည် Burmese Universal AI Writing Studio မှ အလိုအလျောက် ရေးသားပေးထားသော အီးမေးလ်မူကြမ်း ဖြစ်ပါသည်။ လူကြီးမင်း လိုအပ်သလို ပြင်ဆင်အသုံးပြုနိုင်ပါသည်ခင်ဗျာ။\n\nနွေးထွေးစွာဖြင့်၊\n[လူကြီးမင်းအမည်]"
            }
            ...
            trimmed.contains("rewrite") || trimmed.contains("ပြန်ပြင်") -> {
                "$modelHeader\n$detailHeader\n\nကျွန်ုပ်တို့၏ Burmese Universal AI စနစ်သည် သင့်ဖုန်းကို အသံဖြင့် အပြည့်အဝ စီမံထိန်းချုပ်နိုင်ရန် ကူညီပေးမည့် အထူးကောင်းမွန်သော ဆော့ဖ်ဝဲလ်တစ်ခု ဖြစ်ပါသည်ခင်ဗျာ။"
            }
            trimmed.contains("translate") || trimmed.contains("ဘာသာပြန်") -> {
                "$modelHeader\n$detailHeader\n\n\"မင်္ဂလာရှိသော နေ့တစ်နေ့ ဖြစ်ပါစေကြောင်း Burmese Universal AI မှ ဆုမွန်ကောင်းတောင်းအပ်ပါသည်။ (Have a wonderful day, wishes Burmese Universal AI.)\""
            }
            ...
            trimmed.contains("မင်္ဂလာပါ") || trimmed.contains("hello") || trimmed.contains("hi") -> {
                "မင်္ဂလာပါခင်ဗျာ။ ကျွန်တော်ကတော့ Burmese Universal AI Assistant ဖြစ်ပါတယ်။ ဘာများ ကူညီပေးရမလဲခင်ဗျာ။\n\n$modelHeader $detailHeader"
            }
